<template>
 <button class="c-ArticleCard_Status_Item" :class="{_Active : isWant}" v-bind:disabled="isProcessing" @click="toggleWant({ id : gear.id, want_count: want_count, type: isWant })">
