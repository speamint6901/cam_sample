<template>
 <article class="l-Contents_Block-L c-Legal">
  <h1 class="c-Aricle_Hedding u-Hedding_Page u-TxAlign-Center">利用規約</h1>

  <section class="c-Legal_Block">
   <p>
    この利用規約（以下，「本規約」といいます。）は，campbug.net（以下，「当サイト」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
   </p>
  </section><!-- /.c-Legal_Block -->


  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">適用</h3>
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">利用登録</h3>
   <ul class="u-ListStyle-Number">
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">ユーザーIDおよびパスワードの管理</h3>
   <ul class="u-ListStyle-Number">
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">禁止事項</h3>
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">本サービスの提供の停止等</h3>
   <ul class="u-ListStyle-Number">
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">著作権</h3>
   <ul class="u-ListStyle-Number">
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">利用制限および登録抹消</h3>
   <ul class="u-ListStyle-Number">
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">退会</h3>
   <p>ユーザーは，当サイトの定める退会手続により，本サービスから退会できるものとします。</p>
  </section><!-- /.c-Legal_Block -->


  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">保証の否認および免責事項</h3>
   <ul class="u-ListStyle-Number">
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">サービス内容の変更等</h3>
   <p>
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">利用規約の変更</h3>
   <p>
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">個人情報の取扱い</h3>
   <p>
    当サイトは，本サービスの利用によって取得する個人情報については，当サイト<router-link to="/privacy">「プライバシーポリシー」</router-link>に従い適切に取り扱うものとします。
   </p>
  </section><!-- /.c-Legal_Block -->


  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">通知または連絡</h3>
   <p>
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">権利義務の譲渡の禁止</h3>
   <p>
  ...
  <section class="c-Legal_Block -Chapter">
   <h3 class="u-Hedding_Legal c-Legal_Hedding">準拠法・裁判管轄</h3>
   <ul class="u-ListStyle-Number">
    <li>本規約の解釈にあたっては，日本法を準拠法とします。</li>
    <li>本サービスに関して紛争が生じた場合には，当サイトの運営所在地を管轄する裁判所を専属的合意管轄とします。</li>
   </ul>
  </section><!-- /.c-Legal_Block -->
