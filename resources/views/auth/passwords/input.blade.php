  ...
  <article class="p-Password-Reset">
   ...
   <div class="l-Contents u-SiteSize">
    ...
    <div class="l-Contents_Block">
     <h2 class="c-Aricle_Hedding u-Hedding_Page u-TxAlign-Center">パスワード再設定</h2>
    </div><!-- /.l-Contents_Block -->

    <div class="l-Contents_Block">
     <div class="l-Contents_Block-M u-TxAlign-Center u-Margin _mgBottom-base08">
      <p class="">登録しているアカウントに新しいパスワードを設定してください。</p>
     </div>
     <!-- /.l-Contents_Block-XS -->
    </div><!-- /.l-Contents_Block -->
    ...
    <div class="l-Contents_Block">
     <form class="l-Contents_Block-XS u-Margin _mgBottom-base08" action="">
      <input type="password" name="password" id="Password" class="c-Form_Input" placeholder="Password" required>
      <input type="password" name="passwordConfirm" id="PasswordConfirm" class="c-Form_Input"  placeholder="Password確認" required>
      <div class="c-Form_Parts u-Flex _Justify-Center u-Margin _mgTop-base04">
       <button type="submit" class="c-Form_Submit">更新する</button>
      </div>
     </form>
    </div><!-- /.l-Contents_Block -->
