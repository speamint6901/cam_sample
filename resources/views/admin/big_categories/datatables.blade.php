<script>
$(function() {
    var table = $("#big_category-index").DataTable( {
        searching: true,
        processing : true,
        serverSide : true,
        columnDefs : [
        ...
        ajax : {
            url: '{{ route("admin.big_categories.data") }}',
        },
        columns : [
        ...
        fnRowCallback: function(nRow, aData, iDisplayIndex) {
            var addHtml = "";
            var editUrl = "{{ url('big_categories') }}";
            var deleteUrl = "{{ url('big_categories/destroy') }}";
