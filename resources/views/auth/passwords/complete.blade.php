  ...
  <article class="p-Password-Reset">
   ...
   <div class="l-Contents u-SiteSize">
    ...
    <div class="l-Contents_Block">
     <h2 class="c-Aricle_Hedding u-Hedding_Page u-TxAlign-Center">パスワードを再設定しました</h2>
    ...
    <div class="l-Contents_Block">
     ...
     <div class="l-Contents_Block-M u-TxAlign-Center">
      <p class=" u-Margin _mgBottom-base08">パスワードの再設定が完了しました。以下から「ログイン」してください。</p>


      <a class="u-Button_Sub u-Text_Link u-TxtColor_Main" href="/login">ログインページ</a>
     </div>
     <!-- /.l-Contents_Block-XS -->
