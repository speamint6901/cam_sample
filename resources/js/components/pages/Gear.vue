    ...
    <fav :gear="gear_detail"></fav>
     ...
     <ul class="c-MasterItem_SNSshare">
      <li class="c-MasterItem_SNSshare_Item">
       <a :href="'http://www.facebook.com/share.php?u=' + asset_domain + 'gear/' + gear_detail.id" rel="nofollow" target="_blank" class="c-MasterItem_SNSshare_Item-Link" onClick="ga('send', 'event', 'SNSshare', 'click', 'Facebook');">
      ...
      <li class="c-MasterItem_SNSshare_Item">
       <a :href="'https://twitter.com/share?url=' + asset_domain + 'gear/' + gear_detail.id + '&via=Campbug_Outdoor&text=Campbug:['+ gear_detail.brand.name + '] '+ gear_detail.name" rel="nofollow" target="_blank" onClick="ga('send', 'event', 'SNSshare', 'click', 'twitter');">
        <i class="c-MasterItem_SNSshare_Item-Icon">
      ...
      <li class="c-MasterItem_SNSshare_Item">
       <a :href="'https://jp.pinterest.com/pin/create/button/?url=' + asset_domain + 'gear/' + gear_detail.id + '&media=' + asset_domain + 'storage/' + gear_detail.gear_image + '&description=' +'[' + gear_detail.brand.name + '] ' + gear_detail.name" class="c-MasterItem_SNSshare_Item-Link" data-pin-do="buttonPin" data-pin-lang="ja" target="_blank" onClick="ga('send', 'event', 'SNSshare', 'click', 'pinterest');">
        <i class="c-MasterItem_SNSshare_Item-Icon">
      ...
      <li class="c-MasterItem_SNSshare_Item">
       <a :href="'http://getpocket.com/edit?url=' + asset_domain + 'gear/' + gear_detail.id + '&title=' + gear_detail.name" rel="nofollow" target="_blank" class="c-MasterItem_SNSshare_Item-Link" onClick="ga('send', 'event', 'SNSshare', 'click', 'pocket');">
        <i class="c-MasterItem_SNSshare_Item-Icon">
      ...
      <li class="c-MasterItem_SNSshare_Item">
       <a :href="'https://social-plugins.line.me/lineit/share?url=' + asset_domain + 'gear/' + gear_detail.id" target="_blank" rel="nofollow" class="c-MasterItem_SNSshare_Item-Link" onClick="ga('send', 'event', 'SNSshare', 'click', 'line');">
        <i class="c-MasterItem_SNSshare_Item-Icon">
      ...
      <li class="c-MasterItem_SNSshare_Item">
       <a :href="'http://b.hatena.ne.jp/add?mode=confirm&url=' + asset_domain + 'gear/' + gear_detail.id + '&title=' + gear_detail.name" target="_blank" rel="nofollow" class="c-MasterItem_SNSshare_Item-Link" onClick="ga('send', 'event', 'SNSshare', 'click', 'hatena');">
        <i class="c-MasterItem_SNSshare_Item-Icon">
     ...
     <div class="c-MasterItem_ProductLink">
      <a v-if="gear_detail.amazon_url" :href="gear_detail.amazon_url" target="_blank" rel="nofollow" class="c-MasterItem_ProductLink_Btn -Amazon" onClick="ga('send', 'event', 'affiliate', 'click', 'Amazon_Link');">Amazon</a>
      <a v-if="gear_detail.rakuten_url" :href="gear_detail.rakuten_url" target="_blank" rel="nofollow" class="c-MasterItem_ProductLink_Btn -Rakuten" onClick="ga('send', 'event', 'affiliate', 'click', 'Rakuten_Link');">楽天市場</a>
      <a v-if="gear_detail.yahoo_url" :href="gear_detail.yahoo_url" target="_blank" rel="nofollow" class="c-MasterItem_ProductLink_Btn -Yahoo" onClick="ga('send', 'event', 'affiliate', 'click', 'Yahoo_Link');">Yahooショッピング</a>
