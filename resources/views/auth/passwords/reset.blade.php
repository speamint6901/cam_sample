  ...
  <article class="p-Password-Reset">
   ...
   <div class="l-Contents u-SiteSize">
    ...
    <div class="l-Contents_Block">
     <h2 class="c-Aricle_Hedding u-Hedding_Page u-TxAlign-Center">パスワードを忘れた場合</h2>
    </div><!-- /.l-Contents_Block -->

    <div class="l-Contents_Block">
     <div class="l-Contents_Block-M u-TxAlign-Center u-Margin _mgBottom-base08">
      <p class="">パスワードをリセットします。CAMPBUGに登録しているメールアドレスを入力してください。</p>
     </div>
     <!-- /.l-Contents_Block-XS -->
    </div><!-- /.l-Contents_Block -->
    ...
    <div class="l-Contents_Block">
     <form class="l-Contents_Block-XS u-Margin _mgBottom-base08" action="">
      <input type="email" name="email" id="Email" class="c-Form_Input"  placeholder="e-mail">
      <div class="c-Form_Parts u-Flex _Justify-Center u-Margin _mgTop-base04">
       <button type="submit" class="c-Form_Submit">パスワード再設定用メール送信</button>
      </div>
     </form>
    </div><!-- /.l-Contents_Block -->
    ...
    <div class="l-Contents_Block">
     <div class="l-Contents_Block-M u-TxAlign-Center">
      <p class="">入力いただいたメールアドレスに再設定用のURLを送信します。</p>
