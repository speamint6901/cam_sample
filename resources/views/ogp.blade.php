...
<html lang="ja">
 <head>
  ...
  <title>アウトドアギア大百科 Campbug｜{{$gear->name}}:{{$gear->brand->name}}</title>
  ...
  <meta property="og:title" content="アウトドアギア大百科 Campbug｜{{$gear->name}}:{{$gear->brand->name}}" />
  <meta property="og:description" content="{{$gear->discription}}" />
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://www.campbug.net/gear/{{ $gear->id }}" />
  <meta property="og:image" content="https://www.campbug.net/storage/{{ $gear->gear_image }}" />
